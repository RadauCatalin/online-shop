...
public class CustomerServiceIntegrationTests {
    ...
    public void testGetCustomer_whenNonExistingCustomer_thenTrowResourcesNotFoundException() {
    ...
    private Customer createCustomer() {
        SaveCustomerRequest request = new SaveCustomerRequest();
        request.setFirstName("Banana " + System.currentTimeMillis());
        request.setLastName("Healty Food"+ System.currentTimeMillis());
